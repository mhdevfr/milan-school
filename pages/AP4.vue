  ...
  <div class="max-w-4xl mx-auto space-y-8 py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="space-y-4">
      ...
      <div class="text-muted-foreground">
        <p>Ce projet est un site web de recherche d'emploi pour les étudiants, avec un système de chat et de messagerie. Nous avons dû le réaliser en équipe de 3 personnes. Durant ce projet nous avons appliqué la méthode agile et nous avons dû gérer les incidents et les demandes d'évolution. L'architecture MVC (Modèle-Vue-Contrôleur) a été implémentée pour assurer une séparation claire des responsabilités et faciliter la maintenance du code.</p>
      </div>
    </div>
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        <div class="rounded-lg border p-4">
          ...
          <p class="mt-2 text-sm text-muted-foreground">
            Système complet pour gérer les inscriptions utilisateurs d'HiJobs.
          </p>
        </div>
        <div class="rounded-lg border p-4">
          <div class="flex items-center space-x-2">
            ...
            <h3 class="font-semibold">Réalisation en MVC</h3>
          </div>
          <p class="mt-2 text-sm text-muted-foreground">
            Réalisation en MVC (Modèle-Vue-Contrôleur) pour une séparation claire des responsabilités et faciliter la maintenance du code.
          </p>
        </div>
        <div class="rounded-lg border p-4">
          <div class="flex items-center space-x-2">
            ...
            <h3 class="font-semibold">Système de Messagerie</h3>
          </div>
          <p class="mt-2 text-sm text-muted-foreground">
            Système de messagerie permettant aux utilisateurs de discuter entre eux.
          </p>
        </div>
        <div class="rounded-lg border p-4">
          <div class="flex items-center space-x-2">
            ...
            <h3 class="font-semibold">Visuallisation d'offres d'emploi</h3>
          </div>
          <p class="mt-2 text-sm text-muted-foreground">
            Visuallisation d'offres d'emploi permettant aux utilisateurs de voir les offres d'emploi disponibles.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="space-y-4">
      ...
      <div class="text-muted-foreground">
        <p>Le site web HiJobs a été développé en utilisant une architecture MVC (Modèle-Vue-Contrôleur) et les technologies suivantes :</p>
        <ul class="list-disc pl-5 mt-2 space-y-1">
          <li><strong>Modèle :</strong> SQL et PHP pour la couche d'accès aux données et la logique métier</li>
          <li><strong>Vue :</strong> HTML, Tailwind CSS pour l'interface utilisateur responsive</li>
          <li><strong>Contrôleur :</strong> PHP pour la gestion des requêtes et la coordination entre modèle et vue</li>
          <li>Javascript pour les interactions dynamiques côté client</li>
        ...
        <div class="mt-4 p-4 bg-muted rounded-lg">
          <h3 class="font-medium mb-2">Avantages de l'architecture MVC utilisée :</h3>
          <ul class="list-disc pl-5 mt-2 space-y-1 text-sm">
            <li>Séparation claire des responsabilités entre données, présentation et logique</li>
            <li>Facilité de maintenance et d'évolution du code</li>
            <li>Réutilisation des composants entre différentes parties de l'application</li>
            <li>Tests unitaires simplifiés grâce à la séparation des couches</li>
            <li>Travail d'équipe optimisé avec répartition claire des tâches</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="space-y-4">
      ...
      <div class="rounded-lg border p-6">
        <div class="flex flex-col items-center space-y-4">
          ...
          <h3 class="text-lg font-semibold">Accéder au Site Hijobs</h3>
          <p class="text-center text-sm text-muted-foreground">
            Explorez la démo en direct du site web de HiJobs.
          </p>
          <a href="https://hijobs.fwh.is/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90">
            Voir la Démo
